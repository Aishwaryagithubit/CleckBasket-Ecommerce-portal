...
<div class="report-grid">
    <div class="metric">
        ...
        <strong><?= array_sum(array_column($dailyStats, 'TOTAL_ORDERS')) ?></strong>
    </div>

    <div class="metric">
        <span>Total Sales</span>
        <strong>£<?= number_format(array_sum(array_column($dailyStats, 'TOTAL_SALES')), 2) ?></strong>
    </div>

    <div class="metric">
        <span>Completed</span>
        <strong><?= array_sum(array_column($dailyStats, 'COMPLETED_ORDERS')) ?></strong>
    </div>
</div>

<div class="card">
    <h2>Daily Orders Details</h2>
